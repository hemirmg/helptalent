...
@WebServlet(name = "Proyecto2", urlPatterns = {"/Proyecto2"})
@MultipartConfig
public class ProyectoServlet2 extends HttpServlet {
        ...
        if (accion != null) {
            switch (accion) {
                ...
                default:
                    ...
                    request.getRequestDispatcher("proyectos2.jsp").forward(request, response);
            }
        } else {
            proyectos = proyectoDAO.listar();
            request.setAttribute("proyectos", proyectos);
    ...
    private void nuevoProyecto(HttpServletRequest request, HttpServletResponse response)
        ...
        Proyecto proyecto = new Proyecto(nombre, descripcion, descripcion, tipo1, color, tipo2, inversion, pdf);
    ...
    private void verProyecto(HttpServletRequest request, HttpServletResponse response)
        ...
        response.sendRedirect("proyecto/ver2.jsp");
    }

                        ...
                        <c:forEach var="p" items="${proyectos}">
                            <div class="tarjeta">
                                ...
                                <div class="tarjeta-info">
                                    ...
                                    <br>
                                    <br>
                                    <a href="${pageContext.request.contextPath}/Proyecto2?accion=ver&id=<c:out value="${p.idProyecto}"/>" class="boton colorTajeta${p.color}" style="text-decoration: none">Detalles <i class="fas fa-chevron-right"></i></a>

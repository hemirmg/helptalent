                        ...
                        <div class="row">
                            ...
                            <div class="col-md-auto ">
                                <ul class="list-inline">
                                    <li class="list-inline-item" > <a type="button" href="https://wa.me/573177298560" target="_blank" class="btn btn-outline-primary"><i class="fab fa-whatsapp"></i> Whatsapp</a> </li>
                                    <li class="list-inline-item" > <a type="button" href="mailto:hemir@hotmail.com" target="_blank" class="btn btn-outline-primary"><i class="far fa-envelope"></i> Correo Electrónico</a> </li>
                                    <li class="list-inline-item" > <a type="button" href="tel:317729851" target="_blank" class="btn btn-outline-primary "><i class="fas fa-phone-volume"></i> Llamar</a>  </li>
